...
resources = [(institution_id, resource_type, max_cap, random.choice(range(max_cap + 1)), int(datetime.now().timestamp())) for institution_id, resource_type, max_cap in max_capacities]
